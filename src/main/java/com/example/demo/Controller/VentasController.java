	 ...
	 @Autowired
	    ...
	    public String terminarVenta(Model model,@Validated Ventas v, HttpServletRequest request, RedirectAttributes redirectAttrs) {
	        ...
	        for (ProductoParaVender productoParaVender : carrito) {
	            ...
	            ProductosVentas productoVendido = new ProductosVentas(productoParaVender.getId(), productoParaVender.getNombre(),productoParaVender.getPrecio(),productoParaVender.getCantidad(),productoParaVender.getTotal(),p,v);
	            // Y lo guardamos
